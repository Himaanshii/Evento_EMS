  ...
  return (
    <div>
      <header className='flex py-2 px-6 sm:px-6 justify-between place-items-center 
        shadow-[0px_0px_0px_1px_rgba(0,0,0,0.2),0px_1px_1px_-0.5px_rgba(0,0,0,0.03),0px_3px_3px_-1.5px_rgba(0,0,0,0.03),_0px_6px_6px_-3px_rgba(0,0,0,0.02),0px_12px_12px_-6px_rgba(0,0,0,0.03),0px_24px_24px_-12px_rgba(0,0,0,0.03)]
